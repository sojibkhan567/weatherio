/**
 * @license MIT
 * @copyright codewithssojib 2023 All rights reserved
 * @author codewithssojib <sbhossain567@gmail.com>
 */
    ...
    fetchData(url.currentWeather(lat, lon), function(currentWeather) {
        ...
        card.innerHTML = `
            ...
            <h2 class="title-2 card-title">Now</h2>
                <div class="weapper">
                    <p class="heading">${module.convert_temp(temp)}&deg;<sup>c</sup></p>
                        <img class="weather-icon" src="./assets/images/weather_icons/${icon}.png" width="64" height="64" alt="${description}">
                </div>
        ...
        fetchData(url.airPollution(lat, lon), function(airPollution){
            ...
            <h2 class="title-2" id="highlights-label">Today's Highlights</h2>
                        <div class="highlight-list">
                            <!--today highlight air quality card-->
                            ...
                            <!--today highlight Sunrise & Sunset card two-->
                            ...
                            <!--today highlight visibility card-->
                            <div class="card card-sm highlight-card">
                            ...
                            <!--today highlight thermostat card-->
                            <div class="card card-sm highlight-card">
                                <h3 class="title-3">Feels Like</h3>
                                <div class="wrapper">
                                    <span class="m-icon">thermostat</span>
                                    <p class="title-1">${module.convert_temp(feels_like)}&deg;<sup>c</sup></p>
                                </div>
                            </div>
                        </div>
            `;
        ...
        fetchData(url.forecast(lat, lon), function(forecast) {
            ...
            <h2 class="title-2">Today at</h2>
                    <div class="slider-container">
                        ...
                        <!--temprature card list-->
                        <ul class="slider-list" data-temp>
                            
                        </ul>
                        

                        <!-- wind direction card list-->
            ...
            for(const [index, data] of forecastList.entries()) {
                ...
                tempLi.innerHTML = `
                    <div class="card card-sm slider-card">
                        <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                            ...
                            <p>${module.convert_temp(temp)}&deg;<sup>c</sup></p>
                    </div>
                `;
                ...
                <div class="card card-sm slider-card">
                    <p class="body-3">${module.getHours(dateTimeUnix, timezone)}</p>
                            <img src="./assets/images/weather_icons/direction.png" alt="weather-icon" width="48" height="48" loading="lazy" class="weather-icon" style="transform: rotate(${windDirection}deg)">
            ...
            for(let i = 7, len = forecastList.length; i < len; i += 8) {
                ...
                <div class="icon-wrapper">
                    <img
                        ...
                        />
                        <span class="span">
                            <p class="title-2">${module.convert_temp(temp_max)}&deg;<sup>c</sup</p>
                        </span>
                    </div>
